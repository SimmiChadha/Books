...
var app = angular.module("myApp", []).controller("myCtrl", function($scope,$http) {
   ...
   $scope.data=[];
    ...
    $http(	{
    			method: 'POST',
	      		url: 'http://localhost:9001/Book/DeleteCartItems',
...
<h1 class="jumbotron jumbotron-sm" style="margin: auto; text-align: center;">Thank You</h1>

<br><br><br>
<center>
<a href="${flowExecutionUrl}&_eventId=goToPage3" class="btn btn-danger" style=" float:left; margin-left:50px; margin-top:45px">Invoice</a>
<a href="${pageContext.request.contextPath}/" class="btn btn-danger" style=" float:right; margin-right:50px; margin-top:45px">Order Complete</a></center>
