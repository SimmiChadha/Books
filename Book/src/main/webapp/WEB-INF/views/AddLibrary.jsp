...
<h1 class="jumbotron jumbotron-sm" style="margin: auto; text-align: center;">Add Library</h1>

<br>

<form:form method="post" action="AddLibraryToDB" modelAttribute="Library" style="margin: auto; width: 80%; text-align: center;" enctype="multipart/form-data">
	...
	<form:input path="price" type="text" class="form-control" placeholder="Book's Price"/>
	<br>
