...
<h1 class="jumbotron jumbotron-sm" style="margin: auto; text-align: center;">Add Category</h1>

<br>

<form:form method="post" action="AddCategoryToDB" modelAttribute="Category" style="margin: auto; width: 80%; text-align: center;">
